...
|------|-------------|----------|----------|----------|
| VLM (토큰 생성) | 16.45 GB/토큰 | 256회 | 16.45 / 912 × 256 ≈ **4.62s** | 15.16T / 34.1T × 256 ≈ 0.11s |
| Expert (디퓨전) | 4.56 GB/스텝 | 10회 | 4.56 / 912 × 10 ≈ **0.05s** | ~0.01s |
| Vision Encoder | 1.15 GB (1회) | 1회 | ~0.001s | compute ~0.15s |
...
- 가중치 읽기: 16.45 GB / 912 GB/s ≈ **18.0ms** (병목)
- 연산: 7.58B × 2 FLOP / 34.1 TFLOPS ≈ **0.44ms** (읽기의 2.4%)
